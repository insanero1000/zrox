...
module.exports = {
	...
	run: async (client, message, args) => {
		try {
			let button_public_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://clan.milrato.eu")
			let button_support_dc = new MessageButton().setStyle('url').setLabel('Get yourself a own Bot').setURL("https://discord.gg/FQGXbypRf8")

                ...
                try{
                    ...
                    if(member.roles.cache.has(muteuser.role)) {
                        ...
                        channel.send(new Discord.MessageEmbed()
                            ...
                            .setTitle(`<a:yes:833101995723194437> \`${member.user.tag}\` got **UNMUTED** after\`${ms(muteuser.mutetime, { long: true })}\``)
                            .setDescription(`Reason:\n> ${muteuser.reason.substr(0, 1800)}`)
                        );
                    }
